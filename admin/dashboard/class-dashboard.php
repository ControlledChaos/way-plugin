...
class Dashboard {
	...
	private function dependencies() {
        ...
        require WAY_PATH . 'admin/dashboard/class-dashboard-widget.php';

        // Get the welcome panel class.
        require WAY_PATH . 'admin/dashboard/class-welcome.php';
    ...
    public function metaboxes() {
        ...
        if ( way_acf_options() ) {
            ...
            $hide = get_field( 'way_dashboard_hide_widgets', 'option' );
        ...
        // If Advanced Custom Fields is not active.
            ...
            // Get options.
            $welcome    = get_option( 'way_hide_welcome' );
            $gutenberg  = get_option( 'way_hide_try_gutenberg' );
            $editor     = get_option( 'way_classic_editor' );
            $wp_news    = get_option( 'way_hide_wp_news' );
            $quickpress = get_option( 'way_hide_quickpress' );
            $at_glance  = get_option( 'way_hide_at_glance' );
            $activity   = get_option( 'way_hide_activity' );
    ...
    public function add_help() {
		...
		$screen->add_help_tab( [
			...
			'title'    => __( 'Welcome Panel', 'way-plugin' ),
			'content'  => null,
		...
		$screen->add_help_tab( [
			...
			'title'    => __( 'Dashboard Widgets', 'way-plugin' ),
			'content'  => null,
	...
	public function help_welcome_panel() {
        ...
        include_once WAY_PATH . 'admin/dashboard/partials/help/help-welcome-panel.php';
	...
	public function help_dashboard_widgets() {
        ...
        include_once WAY_PATH . 'admin/dashboard/partials/help/help-dashboard-widgets.php';
    ...
    public function help_dashboard_sidebar() {
        ...
        $html  = sprintf(
            '<h4>%1s %2s</h4>',
            __( 'Custom Dashboard for', 'way-plugin' ),
             get_bloginfo( 'name' )
        );
	...
	public function styles() {
        ...
        if ( $screen->id == 'dashboard' ) {
            wp_enqueue_style( WAY_ADMIN_SLUG . '-dashboard', WAY_URL .  'admin/dashboard/assets/css/dashboard.min.css', [], null, 'screen' );
        }
