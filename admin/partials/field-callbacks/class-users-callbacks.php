...
class Users_Callbacks {
	...
	public function block_gravatar( $args ) {
		...
		$option = get_option( 'way_block_gravatar' );

		$html = '<p><input type="checkbox" id="way_block_gravatar" name="way_block_gravatar" value="1" ' . checked( 1, $option, false ) . '/>';

		$html .= '<label for="way_block_gravatar"> ' . $args[0] . '</label></p>';
