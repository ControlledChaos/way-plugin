...
class Settings_Page_Dev_Tools {
	...
	public function settings_page() {
		...
		$this->page_help_section = add_management_page(
			__( 'Website Development', 'way-plugin' ),
			__( 'Site Development', 'way-plugin' ),
			'manage_options',
			WAY_ADMIN_SLUG . '-dev-tools',
			[ $this, 'page_output' ]
		);
	...
	public function page_output() {
		...
		require WAY_PATH . 'admin/partials/settings-page-development.php';
	...
	public function help_dev_info_output() {
		...
		include_once WAY_PATH . 'admin/partials/help/help-dev-info.php';
 ...
 */
function way_settings_page_dev_tools() {
