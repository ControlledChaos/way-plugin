...
class Admin_Menu {
    ...
    public function __construct() {
        ...
        if ( way_acf_options() ) {
            ...
            $options = get_field( 'way_admin_hide_links', 'option' );
        ...
        // Get links option.
        if ( way_acf_options() ) {
            $links = get_field( 'way_links_manager', 'option' );
        } else {
            $links = get_option( 'way_hide_links' );
        }
    ...
    public function hide() {
        ...
        if ( way_acf_options() ) {
            ...
            // Get options.
            $appearance = get_option( 'way_hide_appearance' );
            $plugins    = get_option( 'way_hide_plugins' );
            $users      = get_option( 'way_hide_users' );
            $tools      = get_option( 'way_hide_tools' );
    ...
    public function menus_widgets() {
        ...
        if ( way_acf_options() ) {
            ...
            $menus_link   = get_field( 'way_menus_position', 'option' );
            $widgets_link = get_field( 'way_widgets_position', 'option' );
        ...
        // If ACF is not active.
            ...
            $menus_link   = get_option( 'way_menus_position' );
            $widgets_link = get_option( 'way_widgets_position' );
