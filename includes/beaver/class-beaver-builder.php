...
class WAY_Beaver_Builder {
	...
	static public function load_modules() {
		...
		require_once WAY_PATH . 'includes/beaver/modules/basic-example/basic-example.php';
		require_once WAY_PATH . 'includes/beaver/modules/example/example.php';
	...
	static public function register_fields( $fields ) {
		...
		$fields['way-custom-beaver-field'] = WAY_PATH . 'includes/beaver/fields/custom-fields.php';
		return $fields;
	...
	static public function enqueue_field_assets() {
		...
		wp_enqueue_style( 'way-beaver-fields', WAY_URL . 'includes/beaver/assets/css/fields.css', [], '' );
		wp_enqueue_script( 'way-beaver-fields', WAY_URL . 'includes/beaver/assets/js/fields.js', [], '', true );
...
// Run the class.
$way_beaver_builder = new WAY_Beaver_Builder;