...
namespace WAY_Plugin\Includes\Tools\Customizer_Reset;
...
final class Customizer_Reset {
	...
	public function customize_controls_print_scripts() {
		...
		wp_enqueue_script( 'way-customizer-reset', WAY_URL . 'includes/tools/customizer-reset/assets/js/customizer-reset.js', [ 'jquery' ], '20150120' );

		wp_localize_script( 'way-customizer-reset', '_WAYCustomizerReset', [
			'reset'   => __( 'Reset', 'way-plugin' ),
			'confirm' => __( 'Warning! This will remove all changes made to this theme via the Customizer. This action is irreversible.', 'way-plugin' ),
			'nonce'   => [
