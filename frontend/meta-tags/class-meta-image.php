...
class Meta_Image {
	...
	public function __construct() {
		...
		add_action( 'way_meta_image_tag', [ $this, 'image' ] );
	...
	public function image() {
		...
		if ( way_acf_options() ) {
			...
			$blog_image    = get_field( 'way_meta_blog_image', 'option' );
			$default_image = get_field( 'way_meta_default_image', 'option' );
